begin
  ...
  SPEC = Gem::Specification.new do |s|
    ...
    s.description = <<-END.gsub(/^ +/, "")
     JBinData is a declarative way to read and write binary file formats.
  ...
  file "bindata.gemspec" => ["Rakefile", "lib/jbindata.rb"] do |t|
    require 'yaml'
    open(t.name, "w") { |f| f.puts SPEC.to_yaml }
  end

  CLOBBER.include("jbindata.gemspec")

  desc "Create a stand-alone gemspec"
  task :gemspec => "jbindata.gemspec"
rescue LoadError
